...
namespace Airbnb.Tests.AuthenticationTests
{
    public class LoginTest : TestBase
    {
        ...
        public async Task Login_ShouldReturnSuccessResponse_WhenUserLoginSuccessfully()
        {
            ...
            var handler = new UserService(_userManager, _signInManager.Object, _authService.Object, null, null, null, null, _mediatR.Object, null);
            // Act
        ...
        public async Task Login_ShouldReturnFailureResponse_WhenUserIsNotFound()
        {
            ...
            var handler = new UserService(_userManager, null, null, null, null, null, null, null, null);
            // Act
        ...
        public async Task Login_ShouldReturnFailureResponse_WhenPasswordIsNotCorrect()
        {
            ...
            var handler = new UserService(_userManager, _signInManager.Object, _authService.Object, null, null, null, null, null, null);
            // Act
            var result = await handler.Login(loginDto);
            result.IsSuccess.Should().BeFalse();
            result.StatusCode.Should().Be(HttpStatusCode.BadRequest);
